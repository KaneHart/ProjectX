...
<ic2:quantum_chestplate>.addTooltip(format.red("Requires Full NanoSuit BodyArmor"));
<ic2:quantum_chestplate:26>.addTooltip(format.red("Requires Fully Charged NanoSuit BodyArmor"));
<ic2:quantum_chestplate>.addTooltip(format.red("Requires Full Electric Jetpack"));
...
<ic2:quantum_leggings>.addTooltip(format.red("Requires Full NanoSuit Leggings"));
...
<ic2:quantum_boots>.addTooltip(format.red("Requires Full NanoSuit Boots"));
...
<ic2:quantum_helmet>.addTooltip(format.red("Requires Full NanoSuit Helmet"));
